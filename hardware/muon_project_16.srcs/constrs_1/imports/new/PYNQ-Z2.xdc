...
#set_property -dict {PACKAGE_PIN M14 IOSTANDARD LVCMOS33} [get_ports led_3]
...
set_property -dict {PACKAGE_PIN Y18 IOSTANDARD LVCMOS33} [get_ports {cs[0]}];
set_property -dict {PACKAGE_PIN Y16 IOSTANDARD LVCMOS33} [get_ports {sdata[1]}];
set_property -dict {PACKAGE_PIN Y19 IOSTANDARD LVCMOS33} [get_ports {sdata[0]}];
set_property -dict {PACKAGE_PIN Y17 IOSTANDARD LVCMOS33} [get_ports {sclk[0]}];
set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports {cs[1]}]; #IO_L12P_T1_MRCC_34 Sch=ja_p[3]
set_property -dict { PACKAGE_PIN W18   IOSTANDARD LVCMOS33 } [get_ports {sdata[3]}]; #IO_L12N_T1_MRCC_34 Sch=ja_n[3]
set_property -dict { PACKAGE_PIN U19   IOSTANDARD LVCMOS33 } [get_ports {sdata[2]}]; #IO_L22P_T3_34 Sch=ja_p[4]
set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports {sclk[1]}]; #IO_L22N_T3_34 Sch=ja_n[4]

##PmodB

set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33 } [get_ports {cs[2]}]; #IO_L8P_T1_34 Sch=jb_p[1]
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports {sdata[5]}]; #IO_L8N_T1_34 Sch=jb_n[1]
set_property -dict { PACKAGE_PIN Y14   IOSTANDARD LVCMOS33 } [get_ports {sdata[4]}]; #IO_L1P_T0_34 Sch=jb_p[2]
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports {sclk[2]}]; #IO_L1N_T0_34 Sch=jb_n[2]
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports {cs[3]}]; #IO_L18P_T2_34 Sch=jb_p[3]
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports {sdata[7]}]; #IO_L18N_T2_34 Sch=jb_n[3]
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports {sdata[6]}]; #IO_L4P_T0_34 Sch=jb_p[4]
set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 } [get_ports {sclk[3]}]; #IO_L4N_T0_34 Sch=jb_n[4]
...
set_property -dict { PACKAGE_PIN V6   IOSTANDARD LVCMOS33 } [get_ports {cs[4]}]; #IO_L22P_T3_34 Sch=rpio_02_r
set_property -dict { PACKAGE_PIN Y6   IOSTANDARD LVCMOS33 } [get_ports {sdata[9]}]; #IO_L22N_T3_34 Sch=rpio_03_r
set_property -dict { PACKAGE_PIN C20   IOSTANDARD LVCMOS33 } [get_ports {sdata[8]}]; #IO_L17P_T2_34 Sch=rpio_04_r
set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33 } [get_ports {sclk[4]}]; #IO_L11P_T1_SRCC_13 Sch=rpio_17_r

set_property -dict { PACKAGE_PIN V7    IOSTANDARD LVCMOS33 } [get_ports {cs[5]}]; #IO_L11P_T1_SRCC_13 Sch=rpio_17_r
set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS33 } [get_ports {sdata[11]}]; #IO_L17N_T2_13 Sch=rpio_22_r
set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33 } [get_ports {sdata[10]}]; #IO_L15P_T2_DQS_13 Sch=rpio_10_r
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports {sclk[5]}]; #IO_L21N_T3_DQS_13 Sch=rpio_09_r

set_property -dict { PACKAGE_PIN W10   IOSTANDARD LVCMOS33 } [get_ports {cs[6]}]; #IO_L16P_T2_13 Sch=rpio_11_r
set_property -dict { PACKAGE_PIN F20   IOSTANDARD LVCMOS33 } [get_ports {sdata[13]}]; #IO_L7P_T1_34 Sch=rpio_sd_r
set_property -dict { PACKAGE_PIN F19   IOSTANDARD LVCMOS33 } [get_ports {sdata[12]}]; #IO_L17N_T2_34 Sch=rpio_05_r
set_property -dict { PACKAGE_PIN B20   IOSTANDARD LVCMOS33 } [get_ports {sclk[6]}]; #IO_L7N_T1_34 Sch=rpio_sc_r

set_property -dict { PACKAGE_PIN W8    IOSTANDARD LVCMOS33 } [get_ports {cs[7]}]; #IO_L15N_T2_DQS_13 Sch=rpio_13_r
set_property -dict { PACKAGE_PIN Y8    IOSTANDARD LVCMOS33 } [get_ports {sdata[15]}]; #IO_L14N_T2_SRCC_13 Sch=rpio_19_r
set_property -dict { PACKAGE_PIN W9    IOSTANDARD LVCMOS33 } [get_ports {sdata[14]}]; #IO_L16N_T2_13 Sch=rpio_26_r
set_property -dict { PACKAGE_PIN Y9    IOSTANDARD LVCMOS33 } [get_ports {sclk[7]}]; #IO_L14P_T2_SRCC_13 Sch=rpio_21_r
