...
# module references:
# AD1_mega_controller, muon_trigger_16ch
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set cs [ create_bd_port -dir O -from 7 -to 0 cs ]
  set sclk [ create_bd_port -dir O -from 7 -to 0 sclk ]
  set sdata [ create_bd_port -dir I -from 15 -to 0 sdata ]
  set sysclk [ create_bd_port -dir I -type clk -freq_hz 120000000 sysclk ]

  # Create instance: AD1_mega_controller_0, and set properties
  set block_name AD1_mega_controller
  set block_cell_name AD1_mega_controller_0
  if { [catch {set AD1_mega_controller_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $AD1_mega_controller_0 eq "" } {
  ...
  # Create instance: muon_trigger_16ch_0, and set properties
  set block_name muon_trigger_16ch
  set block_cell_name muon_trigger_16ch_0
  if { [catch {set muon_trigger_16ch_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $muon_trigger_16ch_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
...
\
  ...
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins axi_interconnect_0/S00_AXI] [get_bd_intf_pins axi_dma_0/M_AXI_S2MM]
  ...
  connect_bd_intf_net -intf_net muon_trigger_16ch_0_M_AXIS [get_bd_intf_pins axis_data_fifo_0/S_AXIS] [get_bd_intf_pins muon_trigger_16ch_0/M_AXIS]
  ...
  connect_bd_net -net AD1_mega_controller_0_CS  [get_bd_pins AD1_mega_controller_0/CS] \
  [get_bd_ports cs]
  connect_bd_net -net AD1_mega_controller_0_DATA_OUT  [get_bd_pins AD1_mega_controller_0/DATA_OUT] \
  [get_bd_pins muon_trigger_16ch_0/ADC_DATA_IN]
  connect_bd_net -net AD1_mega_controller_0_SAMPLE_VALID  [get_bd_pins AD1_mega_controller_0/SAMPLE_VALID] \
  [get_bd_pins muon_trigger_16ch_0/SAMPLE_VALID]
  connect_bd_net -net AD1_mega_controller_0_SCLK  [get_bd_pins AD1_mega_controller_0/SCLK] \
  [get_bd_ports sclk]
  connect_bd_net -net SDATA_0_1  [get_bd_ports sdata] \
  [get_bd_pins AD1_mega_controller_0/SDATA]
  connect_bd_net -net axi_gpio_0_gpio_io_o  [get_bd_pins axi_gpio_0/gpio_io_o] \
  [get_bd_pins muon_trigger_16ch_0/SW_TRIGGER_LEVEL]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn  [get_bd_pins proc_sys_reset_0/peripheral_aresetn] \
  [get_bd_pins axis_data_fifo_0/s_axis_aresetn] \
  [get_bd_pins muon_trigger_16ch_0/ARESETN]
  connect_bd_net -net proc_sys_reset_0_peripheral_reset  [get_bd_pins proc_sys_reset_0/peripheral_reset] \
  [get_bd_pins AD1_mega_controller_0/RST]
  ...
  [get_bd_pins AD1_mega_controller_0/CLK] \
  [get_bd_pins muon_trigger_16ch_0/ACLK]
  connect_bd_net -net xlconstant_0_dout  [get_bd_pins xlconstant_0/dout] \
  [get_bd_pins AD1_mega_controller_0/START]
